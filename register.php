...
<button type="submit" class="<?php echo $site_color_accent; ?> btn waves-effect waves-light col s12 m6 l3">Registrieren<i class="material-icons right">send</i></button>
</form>
</div>
