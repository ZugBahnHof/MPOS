	  ...
	  <div class="row">
	    <div class="col s12">
	      <ul class="tabs <?php echo $site_color."-text";?>">
	        <li class="tab col s4"><a class="<?php echo $site_color."-text";?> active" href="#data">Persönliche Daten</a></li>
  ...
  <!-- Persönliche Daten-->
    <div class="row" id="data">
    	<form action="?save=personal_data" method="post" class="col s12">
					...
					<div class="input-field col s12">
						<input class="validate" id="inputEmail" name="email" type="email" value="<?php echo htmlentities($user['email']); ?>" required>
						<label for="inputEmail">E-Mail</label>
					</div>

    			<div class="input-field col s12">
    				<input class="validate" id="inputVorname" name="vorname" type="text" value="<?php echo htmlentities($user['vorname']); ?>" required>
			    	<label for="inputVorname">Vorname</label>
    			</div>

    			<div class="input-field col s12">
    				<input class="validate" id="inputNachname" name="nachname" type="text" value="<?php echo htmlentities($user['nachname']); ?>" required>
    ...
    <div class="row" id="email">
    	<form action="?save=email" method="post" class="col s12">
					<h5>Zum Änderen deiner E-Mail-Adresse gib bitte dein aktuelles Passwort sowie die neue E-Mail-Adresse ein.</h5>
